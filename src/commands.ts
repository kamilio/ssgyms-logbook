...
function client(services: LogbookServices): SsgymsClient {
...
const createWorkout = defineCommand<LogbookServices, "create-workout", typeof createParams, undefined, Awaited<ReturnType<SsgymsClient["createWorkout"]>>, readonly ["cli", "mcp", "sdk"]>({
  name: "create-workout",
  aliases: ["create"],
...
const logWorkout = defineCommand<LogbookServices, "log-workout", typeof logParams, undefined, Awaited<ReturnType<SsgymsClient["logWorkout"]>>, readonly ["cli", "mcp", "sdk"]>({
  name: "log-workout",
  aliases: ["log"],
...
const deleteWorkout = defineCommand<LogbookServices, "delete-workout", typeof deleteParams, undefined, Awaited<ReturnType<SsgymsClient["deleteWorkout"]>>, readonly ["cli", "mcp", "sdk"]>({
  name: "delete-workout",
  aliases: ["delete"],
...
const authSave = defineCommand<LogbookServices, "save", typeof authSaveParams, undefined, { stored: true; file: string }, readonly ["cli"]>({
  name: "save",
...
const authStatus = defineCommand<LogbookServices, "status", typeof emptyParams, undefined, Awaited<ReturnType<SsgymsClient["validateAuthentication"]>>, readonly ["cli"]>({
  name: "status",
...
const authRemove = defineCommand<LogbookServices, "remove", typeof emptyParams, undefined, { removed: true }, readonly ["cli"]>({
  name: "remove",
...
const authChildren = [authLogin, authSave, authStatus, authRemove] as const;
const auth = defineGroup<LogbookServices, "auth", typeof authChildren, readonly ["cli"]>({
  name: "auth",
...
const children = [listWorkouts, createWorkout, logWorkout, deleteWorkout, auth] as const;
export const logbook = defineGroup<LogbookServices, "ssgyms-logbook", typeof children, readonly ["cli", "mcp", "sdk"]>({
  name: "ssgyms-logbook",
