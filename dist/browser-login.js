...
export function createBrowserAuthenticator(options = {}) {
            ...
            return page.evaluate(async (prefix) => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    request.onsuccess = () => {
                        ...
                        read.onsuccess = () => {
                            database.close();
                            const authRecord = read.result.find((record) => record.fbase_key?.startsWith(prefix));
                            const value = authRecord?.value;
